<template>
  <a-card :bordered="false">
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay" >
               <a-menu-item v-if="record.id.indexOf('hh')<0">
    ...
    <appComic-modal ref="modalForm" @ok="modalFormOk"></appComic-modal>
...
<script>
  ...
  import AppComicModal from './modules/AppComicModal'
  ...
  export default {
    ...
    methods: {
      ...
      getCateList(){
        let that = this;
        axios({
          url: "/app/appComicCategory/getList",
          method:'post' ,
          data:{type:0},
