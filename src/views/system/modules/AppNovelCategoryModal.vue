  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/app/appNovelCategory/add",
          edit: "/app/appNovelCategory/edit",
        }
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'categoryName','sort'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'categoryName','notDel','sort','status'))
      }
