...
const addQdUser = (params)=>postAction("/sys/user/addQdUser",params);
const editQdUser = (params)=>putAction("/sys/user/editQdUser",params);
...
const getLoginfo = (params)=>getAction("/app/appAccessLog/loginfo",params);
